    ...
    public partial class blogs : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        IsForwarding = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.PostId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "BlogId", "dbo.Blog");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Comments", "PostId", "dbo.AspNetUsers");
